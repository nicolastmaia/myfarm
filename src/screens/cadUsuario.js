...
import { StyleSheet, ImageBackground, ScrollView, Keyboard, Dimensions } from 'react-native';
import { Input, Item, Button, Text, Icon, View, Picker, Card } from 'native-base';
...
export default function CadUsuario(props) {
	...
	return (
		<ImageBackground blurRadius={8} source={require('../assets/myfarm_bg_grass.jpg')} style={{ flex: 1, width: null, padding: 20, paddingTop: 20 }}>
			...
			{/* stepIndicator */}
			<HideWithKeyboard>
				<StepIndicator currentPosition={posicao} stepCount={3} customStyles={customStyles} labels={labels} />
			</HideWithKeyboard>
